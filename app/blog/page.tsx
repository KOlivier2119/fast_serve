...
const BlogPage = () => {
  // Sample blog post data with real images
  const featuredPost = {
  ...
  const blogPosts = [
    {
      ...
      date: "April 2, 2025",
      author: { name: "Sarah Johnson", initials: "SJ", color: "bg-blue-500" },
    ...
    },
    {
      ...
      date: "March 25, 2025",
      author: { name: "Emily Rodriguez", initials: "ER", color: "bg-pink-500" },
      category: "Meal Ideas",
      readTime: "3 min read",
      comments: 14,
      likes: 89,
    },
    {
      ...
      image: "/blog_delivery.jpg",
      date: "March 20, 2025",
      author: { name: "David Thompson", initials: "DT", color: "bg-orange-500" },
    ...
    },
    {
      ...
      image: "/blog_healthy.jpg",
      date: "March 10, 2025",
      author: { name: "Carlos Mendez", initials: "CM", color: "bg-red-500" },
    ...
    },
    {
      ...
      image: "/blog_restaurant.jpg",
      date: "March 5, 2025",
      author: { name: "Priya Patel", initials: "PP", color: "bg-indigo-500" },
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Blog Hero Section */}
      <div className="relative bg-[#396C03] text-white py-20 md:py-28">
        ...
        <div className="container mx-auto px-4 relative">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="relative max-w-xl mx-auto">
              <div className="flex items-center bg-white rounded-full shadow-xl overflow-hidden px-2 py-1.5">
                <div className="flex items-center text-gray-400 pl-3 pr-2 shrink-0">
                  <Search size={18} />
                </div>
                <input
                  type="text"
                  placeholder="Search for recipes, tips, restaurants..."
                  className="flex-1 py-2 px-2 text-gray-800 placeholder-gray-400 bg-transparent focus:outline-none text-sm"
                />
                <button
                  className="bg-[#FF8B00] hover:bg-[#E07A00] text-white text-sm font-semibold px-5 py-2.5 rounded-full transition-colors duration-200 shrink-0"
                >
                  Search
                </button>
              </div>
            ...
            <div className="bg-white rounded-2xl shadow-sm overflow-hidden mb-12 transition-all duration-300 hover:shadow-md">
              ...
              <div className="p-6 flex items-center justify-between">
                <div className="flex items-center">
                  <div className={`w-10 h-10 rounded-full mr-3 flex items-center justify-center text-white text-sm font-bold ${featuredPost.author.color}`}>
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <div className="flex items-center justify-between mt-auto pt-4 border-t border-gray-100">
                      <div className="flex items-center">
                        <div className={`w-8 h-8 rounded-full mr-2 flex items-center justify-center text-white text-xs font-bold ${post.author.color}`}>
          ...
          <div className="lg:w-1/3 space-y-8">
              ...
              <form className="space-y-3">
                <div className="flex items-center bg-white/10 backdrop-blur-sm border border-white/20 rounded-lg overflow-hidden">
                  <input
                    ...
                    className="flex-1 px-4 py-3 bg-transparent text-white placeholder-white/60 focus:outline-none text-sm"
                  />
                  <button
                    type="submit"
                    className="bg-[#FF8B00] hover:bg-[#E07A00] text-white font-semibold px-5 py-3 transition-colors flex items-center justify-center shrink-0"
                  >
                    <ArrowRight size={16} />
                  </button>
                </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              ...
              <div className="flex flex-col items-center text-center">
                <div className="w-24 h-24 rounded-full mb-4 bg-emerald-500 flex items-center justify-center text-white text-3xl font-bold">
                  JO
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="bg-white rounded-2xl shadow-sm p-8 md:p-12 flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="md:w-1/3 flex justify-center">
              <div className="w-48 h-48 rounded-2xl bg-[#396C03] flex items-center justify-center shadow-xl">
                <Logo size={64} showWordmark={true} variant="default" />
              </div>
            </div>
          </div>
        </div>
